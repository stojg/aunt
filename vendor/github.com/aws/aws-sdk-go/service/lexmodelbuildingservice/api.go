...
type PutIntentInput struct {
	...
	// An array of intent slots. AtX runtime, Amazon Lex elicits required slot values
...
// A collection of messages that convey information to the user. AtX runtime,
...
type Statement struct {
	...
	// AtX runtime, if the client is using the PostText (http://docs.aws.amazon.com/lex/latest/dg/API_runtime_PostText.html)
